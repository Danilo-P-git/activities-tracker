  ...
  return (
    <nav className="bg-background border-b border-border shadow flex items-center px-4 py-2 gap-6 justify-between">
      ...
      <div className="flex gap-4 ml-auto items-center">
        ...
        <a href="/staff" className="text-foreground hover:text-primary font-semibold transition">Staff</a>
        <a href="/metriche" className="text-foreground hover:text-primary font-semibold transition">Metriche</a>
